...
public class AtlasDaoReadTest
{
  ...
  @Test
  public void getCollectionTaxonomyMeta() {
    List<TaxonMeta> taxonomyMeta = dao.getCollectionTaxonomyMeta(1);
    assertCollectionTaxonomyMeta(taxonomyMeta);
  }
  ...
  private static void assertAtlasObject(AtlasObject object) throws MalformedURLException {
    ...
    assertThat(object.getTaxonomy().get(0).getDisplay(), equalTo("Group"));
    assertThat(object.getTaxonomy().get(0).getValue(), equalTo("WOODEN"));
    assertThat(object.getTaxonomy().get(1).getName(), equalTo("family"));
    assertThat(object.getTaxonomy().get(1).getDisplay(), equalTo("Family"));
  ...
  public void getImageByKey() {
    ...
    assertThat(image.getSource(), equalTo("https://upload.wikimedia.org/wikipedia/commons/f/f5/Paris_-_Accordion_Player_-_0956.jpg"));
  ...
  public void getFeaturesMeta() {
    List<FeatureMeta> featuresMeta = dao.getFeaturesMeta();
  ...
  public void searchFeaturesMeta() {
    List<FeatureMeta> featuresMeta = dao.searchFeaturesMeta("eig");
    assertThat(featuresMeta, notNullValue());
  ...
  /**
   * If search criterion is null returns all features meta from database, in name order.
   */
  @Test
  public void searchFeaturesMeta_NullSearch() {
    List<FeatureMeta> featuresMeta = dao.searchFeaturesMeta(null);
    assertThat(featuresMeta, notNullValue());
    assertThat(featuresMeta, hasSize(4));
  ...
  private static void assertCollectionTaxonomyMeta(List<TaxonMeta> taxonomyMeta) {
