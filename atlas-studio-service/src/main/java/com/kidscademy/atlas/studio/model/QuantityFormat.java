...
public class QuantityFormat implements Comparator<Variant>
{
  ...
  {
    MICROGRAM(1000000000, new Symbol("microgram", "micrograms")), MILLIGRAM(1000000, new Symbol("milligram", "milligrams")), GRAM(1000, new Symbol("gram", "grams")), KILOGRAM(1, new Symbol("kg")), TON(0.001, new Symbol("ton", "tons"));
  ...
  {
    SECOND(1, new Symbol("s")), MINUTE(1.0 / 60.0, new Symbol("min")), HOUR(1.0 / 3600.0, new Symbol("h")), DAY(1.0 / 86400.0, new Symbol("day", "days")), YEAR(1.0 / 31556952.0, new Symbol("year", "years"));
  ...
  {
    MILLIMETER(1000, new Symbol("mm")), CENTIMETER(100, new Symbol("cm")), METER(1, new Symbol("m")), KILOMETER(1 / 1000.0, new Symbol("km")), AU(1 / 149597870700.0, new Symbol("AU"));
  ...
  {
    WATT(1, new Symbol("W")), KILOWATT(1 / 1000.0, new Symbol("kW")), MEGAWATT(1 / 1000000.0, new Symbol("MW")), HORSEPOWER(1 / 735.5, new Symbol("hp"));
