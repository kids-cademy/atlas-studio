...
public class BusinessRules {
    ...
    private static final int UNIQUE_COLLECTION_NAME = 0x0002;
    private static final int UNIQUE_OBJECT_NAME = 0x0003;
    ...
    private static final int NO_LINK_SOURCE = 0x0008;

    private final AtlasDao atlasDao;

    public BusinessRules(AtlasDao atlasDao) {
