...
/**
 * Atlas collection groups together {@link AtlasObject} that have something in common. It is the primary mean to distribute atlas content. An atlas application
 * release contains a collection.
 * 
...
public class AtlasCollection implements Key, GraphicObject
{
  ...
  /**
   * Atlas collection languages. These are languages that all objects from collection should support and for which there are translation records created.
   */
  ...
  /**
   * There are more than a single import API used to populate object features. Depending on its objects specifics a collection can have a single features type.
   * For example, if collection deals with edibles its features type is <code>edible-nutrients</code>.
   */
