...
public class KeywordIndex<T extends Comparable<T>> implements Keyword, Comparable<KeywordIndex<T>> {
    ...
    public KeywordIndex(String keyword) {
    ...
    @Override
    public int compareTo(KeywordIndex<T> that) {
