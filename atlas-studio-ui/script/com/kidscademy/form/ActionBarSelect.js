 ...
 */
com.kidscademy.form.ActionBarSelect = class extends js.dom.Control {
	/**
	 ...
	 */
	toString() {
		return "com.kidscademy.form.ActionBarSelect";
	}
};

com.kidscademy.form.ActionBarSelect.Options = class extends js.dom.Element {
	constructor(ownerDoc, node) {
		super(ownerDoc, node);
	 ...
	 */
	toString() {
		return "com.kidscademy.form.ActionBarSelect.Options";
	}
};
