...
com.kidscademy.form.GraphicAssets = class extends js.dom.Element {
	constructor(ownerDoc, node) {
		 ...
		 * @type {com.kidscademy.form.CropMask}
		 */
		this._cropMask = this.getByClass(com.kidscademy.form.CropMask);
		 ...
		 * @type {js.dom.Element}
		 */
		//this._imageSearch = this.getByClass(com.kidscademy.form.ImageSearch);
