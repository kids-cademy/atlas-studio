 ...
 */
com.kidscademy.form.AudioPlayer = class extends js.dom.Element {
	/**
	...
	constructor(ownerDoc, node) {
		...
		/**
		 * Parent form page initialized by {@link #onCreate(com.kidscademy.form.FormPage)}.
	 ...
	 */
	toString() {
		return "com.kidscademy.form.AudioPlayer";
	}
};
